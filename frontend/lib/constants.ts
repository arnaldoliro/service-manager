...
export const ENDPOINTS = {
  ...
  servers: {
    ...
    createService: (id: number) => `/api/servers/${id}/services`,
    deleteService: (id: number, serviceId: number) => `/api/servers/${id}/services/${serviceId}`,
    syncServices: (id: number) => `/api/servers/${id}/services/sync`,
    discoverServices: (id: number) => `/api/servers/${id}/services/discover`,
    serviceDetail: (id: number, name: string) => `/api/servers/${id}/services/${encodeURIComponent(name)}/detail`,
    startService: (id: number, name: string) => `/api/servers/${id}/services/${encodeURIComponent(name)}/start`,
    stopService: (id: number, name: string) => `/api/servers/${id}/services/${encodeURIComponent(name)}/stop`,
    restartService: (id: number, name: string) => `/api/servers/${id}/services/${encodeURIComponent(name)}/restart`,
